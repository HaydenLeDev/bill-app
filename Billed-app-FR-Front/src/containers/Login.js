...
export default class Login {
  ...
  handleSubmitAdmin = e => {
    e.preventDefault()
    console.log(e.target.querySelector("#admin-email-input").value);
    const user = {
      type: "Admin",
      email: e.target.querySelector("#admin-email-input").value,
      password: e.target.querySelector("#admin-password-input").value,
      status: "connected"
    }
    this.localStorage.setItem("user", JSON.stringify(user))
    this.login(user)
